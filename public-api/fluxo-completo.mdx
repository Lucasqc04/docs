...
2. **Receber resposta** - Obter ID do pagamento e dados de cobrança (QR Code e Pix copia e cola)
...
```bash
curl -X GET https://public-api-prod.dominipay.com.br/api-public/payments/pay_123 \
  -H "Authorization: Bearer SEU_TOKEN_AQUI"
```
...
Veja todos os erros possíveis e como tratá-los na [página de Erros](/public-api/errors).
...
const API_URL = 'https://public-api-prod.dominipay.com.br/api-public';
